...
% The sine wave with a lower frequency held its shape better on the app as more points on the sine wave could be sampled as the signal frequency was much less than the app's sampling frequency of 1s. 
...
% discussion that the lag is kept constant

%The evaluation of the signals on the app and PicoLab was limited to qualitative analysis as it was not possible to obtain 
